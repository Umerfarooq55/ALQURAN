...
public class DownloadTask {
    ...
    public DownloadTask(Context context, Button buttonText, String downloadUrl) {
        ...
        downloadFileName = downloadUrl.replace(Utils.mainUrl, "");//Create file0 name by picking download file0 name from URL
    ...
    private class DownloadingTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... arg0) {
            try {
                ...
                outputFile = new File(apkStorage, downloadFileName);//Create Output file0 in Main File
                ...
                while ((len1 = is.read(buffer)) != -1) {
                    fos.write(buffer, 0, len1);//Write new file0
                }
