		...
		for (int i = 0; i < itemCount; i++) {
			...
			rayMenu.addItem(item, new OnClickListener() {
				...
				public void onClick(View v) {
					if (position == 0) {
						Toast.makeText(MainActivity.this, "Blogger",
								Toast.LENGTH_SHORT).show();
					} else if (position == 1) {
						Toast.makeText(MainActivity.this, "Facebook",
								Toast.LENGTH_SHORT).show();
					} else if (position == 2) {
						Toast.makeText(MainActivity.this, "Google",
								Toast.LENGTH_SHORT).show();
					} else if (position == 3) {
						Toast.makeText(MainActivity.this, "Twitter",
								Toast.LENGTH_SHORT).show();
					} else {
						Toast.makeText(MainActivity.this, "Linkedin",
								Toast.LENGTH_SHORT).show();
					}
				}
			});
